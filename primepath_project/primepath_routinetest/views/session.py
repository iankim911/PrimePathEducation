...
def session_list(request):
    ...
    return render(request, 'primepath_routinetest/session_list.html', context)
...
def session_detail(request, session_id):
    ...
    return render(request, 'primepath_routinetest/session_detail.html', context)


@login_required
def grade_session(request, session_id):
    session = get_object_or_404(StudentSession, id=session_id)
    return render(request, 'primepath_routinetest/grade_session.html', {'session': session})
