...
try:
    from . import routinetest_grade_tags
    from . import matrix_filters
    logger.info("[TEMPLATETAGS] Successfully imported routinetest_grade_tags and matrix_filters")
    print("[TEMPLATETAGS] Successfully imported routinetest_grade_tags and matrix_filters")
...
__all__ = ['routinetest_grade_tags', 'matrix_filters']