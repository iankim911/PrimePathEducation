...
class StudentSession(models.Model):
    ...
    school = models.ForeignKey('core.School', on_delete=models.SET_NULL, null=True, blank=True, related_name='routine_sessions')
    ...
    exam = models.ForeignKey('primepath_routinetest.RoutineExam', on_delete=models.CASCADE, related_name='routine_sessions')
    original_curriculum_level = models.ForeignKey(
        'core.CurriculumLevel', 
        on_delete=models.SET_NULL, 
        null=True,
        related_name='routine_original_sessions'
    )
    final_curriculum_level = models.ForeignKey(
        'core.CurriculumLevel', 
        on_delete=models.SET_NULL, 
        null=True,
        related_name='routine_final_sessions'
    )
    ...
    def correct_answers(self):
        ...
        return self.routine_answers.filter(is_correct=True).count()
...
class StudentAnswer(models.Model):
    ...
    session = models.ForeignKey(StudentSession, on_delete=models.CASCADE, related_name='routine_answers')
    question = models.ForeignKey('primepath_routinetest.Question', on_delete=models.CASCADE, related_name='routine_student_answers')
    ...
    def auto_grade(self):
        ...
        from primepath_routinetest.services import GradingService
...
class DifficultyAdjustment(models.Model):
    ...
    session = models.ForeignKey(StudentSession, on_delete=models.CASCADE, related_name='routine_adjustments')
    from_level = models.ForeignKey(
        'core.CurriculumLevel', 
        on_delete=models.CASCADE, 
        related_name='routine_adjustments_from'
    )
    to_level = models.ForeignKey(
        'core.CurriculumLevel', 
        on_delete=models.CASCADE, 
        related_name='routine_adjustments_to'
    )
