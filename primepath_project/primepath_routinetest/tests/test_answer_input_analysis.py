...
def analyze_answer_input_interface():
    ...
    if sessions.exists():
        ...
        try:
            test_url = f'http://127.0.0.1:8000/routine-test/take/{session.id}/'
    ...
    import os
    template_files = [
        'templates/primepath_routinetest/student_test.html',
        'templates/components/primepath_routinetest/question_panel.html',
