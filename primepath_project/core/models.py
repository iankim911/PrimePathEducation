...
class ExamLevelMapping(models.Model):
    ...
    curriculum_level = models.ForeignKey(CurriculumLevel, on_delete=models.CASCADE, related_name='exam_mappings')
    exam = models.ForeignKey('placement_test.Exam', on_delete=models.CASCADE, related_name='level_mappings')
