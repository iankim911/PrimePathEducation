      ...
      <DialogContent className="sm:max-w-[500px] bg-white text-gray-900">
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            ...
            {formData.class_id && formData.student_id && availableStudents.length > 0 && !availableStudents.some(s => s.id === formData.student_id) && (
              <p className="text-sm text-orange-600 col-span-4 text-center">
